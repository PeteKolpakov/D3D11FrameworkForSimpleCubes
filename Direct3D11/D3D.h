...
private:
	...
	IDXGISwapChain* _pDXGISwapChain = nullptr; // hold references to the front and back buffer and swap them
	ID3D11RenderTargetView* _pRenderTargetView = nullptr; // describe a target the render pipeline can render on, e.g. back buffer render target
};
